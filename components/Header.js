      ...
      <div className="text-center">
        <div className="inline-block mb-6">
          <div className="flex items-center gap-3 bg-gradient-to-r from-slate-900 to-slate-800 px-6 py-2 rounded-full shadow-lg">
            ...
            <span className="text-white font-medium text-sm tracking-wide">
              {todayCount} emails de relance générés aujourd'hui
            </span>
          </div>
        </div>

        <h1 className="text-5xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight">
          Générez vos emails de relance
          <br />
          <span className="bg-gradient-to-r from-amber-500 to-amber-600 bg-clip-text text-transparent">
            professionnels en 30 secondes
          </span>
        </h1>

        <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed">
          Des emails de relance personnalisés générés par IA.
          <br />
          Augmentez votre taux de réponse de 85% avec des messages adaptés à chaque situation.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-8 text-sm text-slate-500 mb-12">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">3 versions par email</span>
          </div>
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-amber-500" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
